	...
	<div class="cafe-main">
		<?php while ( have_posts() ) :
			...
			<article id="post-<?php the_ID(); ?>" <?php post_class( 'image-attachment' ); ?>>
				...
				<div class="cafe-post-content entry-content">
					...
					<div class="entry-description">
						<?php the_content();
						wp_link_pages( array(
							'before' => '<div class="page-links">' . __( 'Pages:', 'cafe' ),
							'after'  => '</div>',
						) ); ?>
			...
			<nav id="cafe-image-navigation" class="cafe-nav-single cafe-clearfix cafe-nav-link" role="navigation">
				<div class="cafe-nav-previous post-nav-prev alignleft">
					<h3><?php previous_image_link( false, '&larr;&nbsp;' . __( 'Previous image', 'cafe' ) ); ?></h3></div>
				<div class="cafe-nav-next post-nav-next alignright">
					<h3><?php next_image_link( false, __( 'Next image', 'cafe' ) . '&nbsp;&rarr;' ); ?></h3></div>
