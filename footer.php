...
<footer class="cafe-site-footer">
					...
					<ul>
						...
						foreach ( $recent_posts as $recent ) : ?>
							<li class="recentposts">
								...
								<p><?php _e( 'posted by', 'cafe' ); ?>&nbsp;<span class="cafe_lowercase"><a href="<?php the_author_link(); ?>"><?php the_author(); ?></a></span>&nbsp;<?php _e( 'in', 'cafe' ); ?>&nbsp;<span class="cafe_lowercase"><?php the_category( ', ' ); ?></span>
								</p>
							</li>
						<?php endforeach; ?>
					</ul>
	...
	<div class="cafe-footer-site-info-area">
		<div class="cafe-footer-site-info">
			<span><?php _e( 'Designed with love by', 'cafe' );
				echo '&nbsp;' ?><a href="<?php echo esc_url( wp_get_theme()->get( 'AuthorURI' ) ); ?>">BestWebLayout</a></span>
			<a href="#cafe-content">
